...
CLR_BITS(PWMPOL, PWMPOL_PPOL4_MASK);        // channel 0 output low at the start of the period
...
CLR_BITS(PWMPOL, PWMPOL_PPOL5_MASK);        // channel 0 output low at the start of the period
