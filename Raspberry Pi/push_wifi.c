...
char LastMessage[20];
char ReadBuf[20];
char buffer[20];	// data buffer for communications
...
main()
{
	...
	/*Creation of threads	 */
	iret2 = pthread_create(&thread2, NULL, startClient, (void*) message1);
	if(iret2)
	{
